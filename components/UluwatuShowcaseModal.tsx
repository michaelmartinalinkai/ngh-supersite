...
export default function UluwatuShowcaseModal({
  ...
  const host = (() => {
    try {
      ...
      return 'legacy.uluwatuparadise.com';
    }
  })();
    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          role="dialog"
          aria-modal="true"
          aria-label="Original Uluwatu Paradise website"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        ...
        >
          ...
          >
            ...
            >
              ...
              <span
                className="ml-1 hidden sm:inline uppercase tracking-[0.14em] text-[10px] px-2 py-0.5 rounded-full"
          ...
          >
            ...
            {!loaded && (
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-4" style={{ color: '#8A8F83' }}>
                ...
                />
                <span className="text-xs uppercase tracking-[0.2em]">Loading the original site</span>
              </div>
            )}
            <iframe
              key={url}
              src={url}
              title="Original Uluwatu Paradise website"
